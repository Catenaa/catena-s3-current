...
repairCfg = {
	...
	fixMessages = {
        ...
        "you have temporarily stopped the oil leakage",
    ...
    noFixMessages = {
        ...
        "You looked at the duck tape on your oil hose and looked okay",
        "You turned up the radio. The weird engine noise is now gone",
        "The rust remover you used had no effect",
        "Never try to fix something that isn't broken, but you didn't listen"
    },
	noFixMessageCount = 6
}
