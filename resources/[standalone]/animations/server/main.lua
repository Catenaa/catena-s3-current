...
QBCore.Commands.Add("emotes", "Toggle animations menu", {}, false, function(source, args)
	TriggerClientEvent('animations:client:ToggleMenu', source)
end)

QBCore.Commands.Add("e", "Use an animation, for animation list do /em", {{name = "name", help = "Emote name"}}, true, function(source, args)
