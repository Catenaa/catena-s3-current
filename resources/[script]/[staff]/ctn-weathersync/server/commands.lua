...
QBCore.Commands.Add("clock", "Check time", {}, false, function(source, args)
    if tonumber(args[1]) ~= nil and tonumber(args[2]) ~= nil then
        SetExactTime(args[1], args[2])
    end
end, "admin")

QBCore.Commands.Add("time", "Change time", {}, false, function(source, args)
...
QBCore.Commands.Add("weather", "Change weather", {}, false, function(source, args)
...
QBCore.Commands.Add("freeze", "Freeze time", {}, false, function(source, args)
