...
AddEventHandler("ctn-queue:playerConnecting", function(source, reject, d)
    ...
    d.defer()
    Wait(50)
    d.update('Handshaking with Catena Queue.')
    Wait(75)
    d.update('Handshaking with Catena Queue..')
    Wait(75)
    d.update('Handshaking with Catena Queue...')
...
function createEnding(text, clr)
	...
	local strr = tostring([[
		...
		{
			"type": "TextBlock",
			"text": "Reserve your queue place now! https://discord.gg/Gb3qY9b",
			"horizontalAlignment": "Center",
			"weight": "Bolder",
			"color": "]] .. colorr .. [[",
			"size": "Small",
	...
	local strr = tostring([[
		{
			...
			"body": [
				{
					"type": "Image",
					"url": "https://cdn.discordapp.com/attachments/701920559948234882/705288285932748830/ctna_clean_lgo_v3.png",
					"horizontalAlignment": "Center",
					"width": "70px",
					"spacing": "Small"
				},
