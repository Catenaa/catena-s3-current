...
RegisterServerEvent('ctn-trucker:server:DoBail')
AddEventHandler('ctn-trucker:server:DoBail', function(bool, vehInfo)
    local src = source
    ...
    if bool then
        if Player.PlayerData.money.cash >= Config.BailPrice then
            ...
            TriggerClientEvent('ctn-trucker:client:SpawnVehicle', src, vehInfo)
...
RegisterNetEvent('ctn-trucker:server:01101110')
AddEventHandler('ctn-trucker:server:01101110', function(drops)
    local src = source 
    local Player = QBCore.Functions.GetPlayer(src)
    ...
    TriggerClientEvent('chatMessage', source, "BAAN", "warning", "You received your salary from: €"..payment..", gross: €"..price.." (bonus €"..bonus.." bonus) and €"..taxAmount.." tax ("..PaymentTax.."%)")
end)
