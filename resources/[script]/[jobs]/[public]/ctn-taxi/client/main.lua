...
RegisterNetEvent('ctn-taxi:client:DoTaxiNpc')
AddEventHandler('ctn-taxi:client:DoTaxiNpc', function()
            ...
            if dist < 20 then
                ...
                if dist < 5 then
                    ...
                    if IsControlJustPressed(0, Keys["E"]) then
                        ...
                        TriggerServerEvent('ctn-taxi:server:NpcPay', meterData.currentFare)
...
RegisterNetEvent('ctn-taxi:client:toggleMeter')
AddEventHandler('ctn-taxi:client:toggleMeter', function()
    local ped = GetPlayerPed(-1)
...
RegisterNetEvent('ctn-taxi:client:enableMeter')
AddEventHandler('ctn-taxi:client:enableMeter', function()
    local ped = GetPlayerPed(-1)
...
RegisterNetEvent('ctn-taxi:client:toggleMuis')
AddEventHandler('ctn-taxi:client:toggleMuis', function()
    Citizen.Wait(400)
    if meterIsOpen then
...
Citizen.CreateThread(function()
    ...
    AddTextComponentSubstringPlayerName("Taxi Center")
