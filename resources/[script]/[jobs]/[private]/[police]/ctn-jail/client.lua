    ...
    while true do
        ...
        if waitCheck < 1.5 then
            if IsControlJustPressed(0,46) then
                ...
                QBCore.Functions.Notify("You have re-claimed your possessions.", "success")
                Wait(15000)
            end
        end
...
AddEventHandler('beginJail', function(time, delivery)
    ...
    FreezeEntityPosition(playerPed, false)
    DoScreenFadeIn(1500)
    TriggerServerEvent("QBCore:Server:SetMetaData", "injail", minutes)
    imjailed = true
    ...
    while imjailed do
        ...
        timer = timer - 1
        TriggerServerEvent("QBCore:Server:SetMetaData", "injail", timer)
    ...
    TriggerServerEvent("QBCore:Server:SetMetaData", "injail", 0)
