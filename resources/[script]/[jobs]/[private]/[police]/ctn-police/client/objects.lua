...
AddEventHandler('police:client:spawnCone', function()
    QBCore.Functions.Progressbar("spawn_object", "Placing Cone", 1800, false, true, {
...
AddEventHandler('police:client:spawnBarier', function()
    QBCore.Functions.Progressbar("spawn_object", "Placing Barrier", 1800, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
...
AddEventHandler('police:client:spawnSchotten', function()
    QBCore.Functions.Progressbar("spawn_object", "Placing Object", 1800, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
...
AddEventHandler('police:client:deleteObject', function()
    ...
    if dist < 5.0 then
        QBCore.Functions.Progressbar("remove_object", "Removing Object", 1800, false, true, {
            disableMovement = true,
            disableCarMovement = true,
            disableMouse = false,
            disableCombat = true,
...
AddEventHandler('police:client:deleteAreaObjects', function()
    ...
    QBCore.Functions.Progressbar("remove_object", "Removing Objects", 1800, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
