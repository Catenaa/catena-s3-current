...
AddEventHandler("evidence:client:ClearBlooddropsInArea", function()
	...
	local blooddropList = {}
	QBCore.Functions.Progressbar("clear_blooddrops", "Collecting Blood Samples", 5000, false, true, {
...
Citizen.CreateThread(function()
	while true do
		Citizen.Wait(10)
		if isLoggedIn then 
			if (PlayerJob.name == "police" and onDuty) or (PlayerJob.name == "gendarme" and onDuty) then
