...
QBCore.Commands.Add("dispatch", "Emergency Dispatch Control.", {{name="type", help="ON/OFF/MUTE"}}, true, function(source, args)
    TriggerClientEvent("dispatch:toggleNotifications", source, args[1])
end)

local DispatchMessages = {
    ['10-50'] = { ['label'] = 'Car crash reported', ['reporter'] = false, ['police'] = true, ['ambulance'] = false, ['priority'] = 3, ['blipSprite'] = 380, ['blipColor'] = 4 }, -- Officer Car Crash
    ['10-10'] = { ['label'] = 'Fight in progress', ['reporter'] = false, ['police'] = false, ['ambulance'] = false, ['blipSprite'] = 311, ['blipColor'] = 4 }, -- Fight
    ['10-11'] = { ['label'] = 'Deadly armed fight in a progress', ['reporter'] = false, ['police'] = true, ['ambulance'] = false, ['blipSprite'] = 313, ['blipColor'] = 4 }, -- Armed Fight
    ['10-31A'] = { ['label'] = 'House Robbery in action', ['reporter'] = false, ['police'] = true, ['ambulance'] = false, ['blipSprite'] = 418, ['blipColor'] = 4 }, -- House Robbery
    ['10-40A'] = { ['label'] = 'Store Robbery in action', ['reporter'] = false, ['police'] = true, ['ambulance'] = false, ['blipSprite'] = 156, ['blipColor'] = 4 }, -- Store Robbery
    ['10-90'] = { ['label'] = 'Robbery of a bank truck in progress', ['reporter'] = false, ['police'] = true, ['ambulance'] = false, ['important'] = true, ['blipSprite'] = 67, ['blipColor'] = 2 }, -- Bank Truck Robbery
