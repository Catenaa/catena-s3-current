...
QBCore.Functions.CreateCallback('ctn-hotdogjob:server:HasMoney', function(source, cb)
...
QBCore.Functions.CreateCallback('ctn-hotdogjob:server:BringBack', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
...
RegisterServerEvent('ctn-hotdogjob:server:Sell')
AddEventHandler('ctn-hotdogjob:server:Sell', function(Amount, Price)
    local src = source
...
RegisterServerEvent('ctn-hotdogjob:server:UpdateReputation')
AddEventHandler('ctn-hotdogjob:server:UpdateReputation', function(quality)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    ...
    if Reset then
        ...
        TriggerClientEvent('ctn-hotdogjob:client:UpdateReputation', src, JobReputation)
        return
    end
...
QBCore.Commands.Add("removestand", "", {}, false, function(source, args)
    TriggerClientEvent('ctn-hotdogjob:staff:DeletStand', source)
end, 'admin')