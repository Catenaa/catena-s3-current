...
AddEventHandler('hospital:client:UseBandage', function()
    QBCore.Functions.Progressbar("use_bandage", "Healing", 5000, false, true, {
...
AddEventHandler('hospital:client:UseFirstAid', function()
    QBCore.Functions.Progressbar("use_firstaid", "Healing", 10000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
        ...
        StopAnimTask(GetPlayerPed(-1), "amb@world_human_clipboard@male@idle_a", "idle_c", 1.0)
        TriggerServerEvent("QBCore:Server:RemoveItem", "firstaid", 1)
...
AddEventHandler('hospital:client:UseMedkit', function()
    QBCore.Functions.Progressbar("use_medkit", "Healing", 10000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
        ...
        StopAnimTask(GetPlayerPed(-1), "amb@world_human_clipboard@male@idle_a", "idle_c", 1.0)
        TriggerServerEvent("QBCore:Server:RemoveItem", "medkit", 1)
...
AddEventHandler('hospital:client:UsePainkillers', function()
    QBCore.Functions.Progressbar("use_bandage", "Consuming Painkillers", 3000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
