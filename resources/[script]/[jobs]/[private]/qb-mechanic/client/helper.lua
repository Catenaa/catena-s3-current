...
function repairtVehicle(vehicle)
	if (not isOpenByAdmin) then
		...
		QBCore.Functions.Progressbar("veh_fix", "Fixing the vehicle", fixingTime, false, true, {
			...
			if (not cancelled) then
				...
				QBCore.Functions.Progressbar("veh_clean", "Cleaning the vehicle", fixingTime, false, true, {
						disableMovement = true,
						disableCarMovement = true,
						disableMouse = false,
						disableCombat = true,
