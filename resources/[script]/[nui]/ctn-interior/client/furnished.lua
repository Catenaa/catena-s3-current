...
RegisterNetEvent('ctn-interior:client:SetNewState')
AddEventHandler('ctn-interior:client:SetNewState', function(bool)
	IsNew = bool
end)
...
function CreateApartmentFurnished(spawn)
	...
	if IsNew then
		SetTimeout(750, function()
			TriggerEvent('ctn-clothes:client:CreateFirstCharacter')
			IsNew = false
		end)
	end
    return { objects, POIOffsets }
