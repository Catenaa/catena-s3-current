    ...
    window.addEventListener('message', function (event) {
        ...
        if (data.action == "ui") {
            if (data.toggle) {
                ...
                var originalText = "Retrieve player data";
                ...
                var DotsInterval = setInterval(function() {
                    ...
                    if (loadingProgress == 4) {
                        originalText = "Retrieve player data"
                        $("#loading-text").html(originalText);
                    }
                ...
                setTimeout(function(){
                    $.post('http://ctn-multicharacter/setupCharacters');
                    setTimeout(function(){
                        ...
                        $.post('http://ctn-multicharacter/removeBlur');
                    }, 2000);
                }, 2000);
            } else {
...
$('.disconnect-btn').click(function(e){
    ...
    $.post('http://ctn-multicharacter/closeUI');
    $.post('http://ctn-multicharacter/disconnectButton');
});
...
$(document).on('click', '.character', function(e) {
    ...
    if (selectedChar === null) {
        ...
        if ((selectedChar).data('cid') == "") {
            ...
            $.post('http://ctn-multicharacter/cDataPed', JSON.stringify({
                cData: cDataPed
            }));
        } else {
            $(selectedChar).addClass("char-selected");
...
$(document).on('click', '#create', function(e){
    e.preventDefault();
    $.post('http://ctn-multicharacter/createNewCharacter', JSON.stringify({
...
$(document).on('click', '#accept-delete', function(e){
    $.post('http://ctn-multicharacter/removeCharacter', JSON.stringify({
...
$(document).on('click', '#play', function(e) {
    ...
    if (selectedChar !== null) {
        if (charData !== "") {
            $.post('http://ctn-multicharacter/selectCharacter', JSON.stringify({
