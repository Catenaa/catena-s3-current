...
QB.Doors = {
	{
		...
		authorizedJobs = { 'police', 'gendarme' },
		locking = false,
		locked = false,
		pickable = false,
		distance = 2.5,
	...
	-----
	{
		...
		--objYaw = -90.0,
		objCoords  = vector3(410.99, -1027.0, 29.99),
		textCoords = vector3(410.9, -1027.04, 30.5),
		authorizedJobs = { 'police', 'gendarme' },
		locking = false,
		locked = true,
		pickable = false,
	...
	-- Entrance Doors 
	{
		...
		authorizedJobs = { 'cardealer', 'police', 'gendarme' },
		locking = false,
		locked = true,
		pickable = false,
		distance = 3.5,
	...
	
	{
		...
		objCoords  = vector3(1854.69, 3683.3, 34.26),				
		textCoords = vector3(1854.69, 3683.3, 34.26),	
	...
	{
		objName = 'v_ilev_ph_gendoor004',
		objCoords  = vector3(1850.99, 3682.48, 34.28),				
		textCoords = vector3(1850.99, 3682.48, 34.28),
		authorizedJobs = { 'gendarme' },
		objYaw = 120.0,
		locking = false,
		locked = true,
	...
	{
		objName = 'v_ilev_ph_cellgate',
		objCoords  = vector3(1848.57, 3680.69, 34.28),				
		textCoords = vector3(1848.57, 3680.69, 34.28),
		authorizedJobs = { 'gendarme' },
		objYaw =  120.0,
		locking = false,
		locked = true,
	...
	{
		objName = 'v_ilev_ph_cellgate',
		objCoords  = vector3(1845.92, 3685.43, 34.28),				
		textCoords = vector3(1845.92, 3685.43, 34.28),	
		authorizedJobs = { 'gendarme' },
		objYaw =  -60.0,
		locking = false,
		locked = true,
	...
	{
		objName = 'v_ilev_ph_gendoor004',
		objCoords  = vector3(1848.25, 3690.61, 34.28),				
		textCoords = vector3(1848.25, 3690.61, 34.28),			
		authorizedJobs = { 'gendarme' },
		objYaw = 30.0,
		locking = false,
		locked = true,
	...
	{
		objName = 'v_ilev_ph_gendoor004',
		objCoords  = vector3(1845.07, 3688.85, 34.28),				
		textCoords = vector3(1845.07, 3688.85, 34.28),			
		authorizedJobs = { 'gendarme' },
		objYaw = 30.0,
		locking = false,
		locked = true,
	...
	{
		objName = 'v_ilev_ph_gendoor004',
		objCoords  = vector3(1842.75, 3691.35, 34.28),				
		textCoords = vector3(1842.75, 3691.35, 34.28),			
		authorizedJobs = { 'gendarme' },
		objYaw = -60.0,
		locking = false,
		locked = true,
	...
	{
		objName = 'v_ilev_ph_gendoor004',
		objCoords  = vector3(1851.39, 3693.5, 34.28),				
		textCoords = vector3(1851.39, 3693.5, 34.28),			
		authorizedJobs = { 'gendarme' },
		objYaw = 120.0,
		locking = false,
		locked = true,
	...
	{
		objName = 'v_ilev_ph_gendoor004',
		objCoords  = vector3(1853.92, 3693.87, 34.35),				
		textCoords = vector3(1853.92, 3693.87, 34.35),			
		authorizedJobs = { 'gendarme' },
		objYaw = 30.0,
		locking = false,
		locked = true,
	...
	{
		objName = 'v_ilev_ph_gendoor004',
		objCoords  = vector3(1856.31, 3689.65, 34.28),				
		textCoords = vector3(1856.31, 3689.65, 34.28),			
		authorizedJobs = { 'gendarme' },
		objYaw = 30.0,
		locking = false,
		locked = true,
...
---- Tequilala
{
	...
	objCoords  = vector3(-564.14, 276.68, 83.13),			
	textCoords = vector3(-564.14, 276.68, 83.13),	
...
{
	objName = 'v_ilev_roc_door4',
	objCoords  = vector3(-562.12, 293.63, 87.62),			
	textCoords = vector3(-562.12, 293.63, 87.62),	
	authorizedJobs = { 'tequilala' },
	locking = false,
	locked = true,
	pickable = false,
...

{
	...
	objCoords  = vector3(-569.87, 292.96, 79.17),			
	textCoords = vector3(-569.87, 292.96, 79.17),	
	authorizedJobs = { 'tequilala' },
	locking = false,
	locked = true,
	pickable = false,
...
---- Store place
{
	objName = 'v_ilev_epsstoredoor',
	objCoords  = vector3(242.35, 360.78, 105.73),			
	textCoords = vector3(242.35, 360.78, 105.73),
	authorizedJobs = { 'sama9aho' },
	locking = false,
	locked = true,
	pickable = false,
	distance = 2.0,
...
---- Shop
{	
	textCoords = vector3(17.26, -1115.08, 29.8),
	authorizedJobs = { 'sama9aho' },
	locking = false,
	locked = true,
	pickable = false,
	...
	size = 2,
			doors = {
		{
			...
			--objYaw = 120.0,
			objCoords = vector3(17.26, -1115.08, 29.8)
		},
...
-- STAND de tir
{
	...
	objCoords  = vector3(7.68, -1098.51, 29.79),			
	textCoords = vector3(7.68, -1098.51, 29.79),
	authorizedJobs = { 'sama9aho' },
	locking = false,
	locked = true,
	pickable = false,
...

	{
		...
		objCoords  = vector3(-1511.01, 116.76, 55.66),			
		textCoords = vector3(-1511.01, 116.76, 55.66),
	...
	{
		objName = 'v_ilev_ra_door4r',
		objCoords  = vector3(-1504.9, 111.14, 55.66),			
		textCoords = vector3(-1504.9, 111.14, 55.66),
		authorizedJobs = { 'state' },
		locking = false,
		locked = true,
		pickable = false,
	...
	{
		objName = 'v_ilev_ra_door4r',
		objCoords  = vector3(-1501.27, 103.31, 55.65),			
		textCoords = vector3(-1501.27, 103.31, 55.65),	
		authorizedJobs = { 'state' },
		locking = false,
		locked = true,
		pickable = false,
...

	{
		...
		objCoords  = vector3(-1522.27, 142.72, 55.66),			
		textCoords = vector3(-1522.27, 142.72, 55.66),
		authorizedJobs = { 'state' },
		locking = false,
		locked = true,
		pickable = false,
...

	{
		...
		objYaw = 90.0,
		objCoords  = vector3(-1613.67, 78.17, 62.41),	
		textCoords = vector3(-1613.67, 78.17, 62.41),	
		authorizedJobs = { 'state' },
		locking = false,
		locked = true,
		pickable = false,
...

	{
		objName = 'prop_lrggate_02_ld',
		objYaw = 90.0,
		objCoords  = vector3(-1471.2, 68.52, 53.75),	
		textCoords = vector3(-1471.2, 68.52, 53.75),	
		authorizedJobs = { 'state' },
		locking = false,
		locked = true,
		pickable = false,
	...
	{
		textCoords = vector3(-1506.43, 118.67, 55.66),
		authorizedJobs = { 'state' },
		locking = false,
		locked = true,
		pickable = false,
		...
		doors = {
			{
				objName = 'v_ilev_ra_door4r',
				objCoords = vector3(-1505.94, 118.24, 55.66)
			},

			{
				objName = 'v_ilev_ra_door4r',
				objCoords = vector3(-1506.82, 119.07, 55.66)
			}
		}
	},

	{
		textCoords = vector3(-1519.86, 123.91, 55.66),
		authorizedJobs = { 'state' },
		locking = false,
		locked = true,
		pickable = false,
		...
		doors = {
			{
				objName = 'v_ilev_ra_door4r',
				objCoords = vector3(-1519.47, 123.54, 55.66)
			},

			{
				objName = 'v_ilev_ra_door4r',
				objCoords = vector3(-1520.27, 124.22, 55.66)
			}
		}
	},
