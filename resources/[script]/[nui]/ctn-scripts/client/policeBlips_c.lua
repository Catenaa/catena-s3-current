local Blips = {}
RegisterNetEvent('ctn-blips:client:updateBlips')
AddEventHandler('ctn-blips:client:updateBlips', function(data)
    ...
    if job ~= 'police' and job ~= 'gendarme' and job ~= 'ambulance' then
        return
    end
