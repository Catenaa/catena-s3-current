...
$(document).on("click", "#button", function (e) {
    ...
    if (btnType == "park") {
        ...
        if (currentType == 'garages') {
            $.post("https://ctn-garages/payout", JSON.stringify({
                    garage: activeGarage,
        ...
        $.post("https://ctn-garages/waypoint", JSON.stringify({
            name: btnName,
            type: btnType,
        }));
        ...
        setTimeout(() => { 
            ...
            $.post("https://ctn-garages/vehicleblip", JSON.stringify({
                plate: btnPlate,
        }));
        }, 2000);
    }
