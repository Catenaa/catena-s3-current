...
RegisterNUICallback("doATMWithdraw", function(data, cb)
    if data ~= nil then
        TriggerServerEvent('ctn-atms:server:doAccountWithdraw', data)
    end
end)

RegisterNetEvent('ctn-atms:client:updateBankInformation')
AddEventHandler('ctn-atms:client:updateBankInformation', function(banking)
    SendNUIMessage({
...
RegisterNUICallback("loadBankingAccount", function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-atms:server:loadBankAccount', function(banking)
...
RegisterNetEvent('ctn-atms:client:loadATM')
AddEventHandler('ctn-atms:client:loadATM', function(cards)
...
RegisterNUICallback("removeCard", function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-debitcard:server:deleteCard', function(hasDeleted)
        if hasDeleted then
            SetNuiFocus(false, false)
            SendNUIMessage({
                status = "closeATM"
