...
$(document).on('click', '.house-key-delete', function(e){
    ...
    $.post('http://ctn-phone_new/RemoveKeyholder', JSON.stringify({
        HolderData: Data,
...
$(document).on('click', '#myhouse-option-transfer-confirm', function(e){
    ...
    $.post('http://ctn-phone_new/TransferCid', JSON.stringify({
        newBsn: NewBSN,
        HouseData: CurrentHouseData,
        ...
        if (CanTransfer) {
            ...
            QB.Phone.Notifications.Add("fas fa-home", "Estate", "This is an invalid social security number", "#27ae60", 2500);
