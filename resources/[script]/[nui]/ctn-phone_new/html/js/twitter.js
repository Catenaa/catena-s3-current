...
$(document).on('click', '.twitter-header-tab', function(e){
    ...
    if (PressedTwitterTab !== CurrentTwitterTab) {
        ...
        if (PressedTwitterTab === "twitter-mentions") {
            $.post('http://ctn-phone_new/ClearMentions');
        }
...
$(document).on('click', '#send-tweet', function(e){
    ...
    if (TweetMessage != "") {
        ...
        $.post('http://ctn-phone_new/PostNewTweet', JSON.stringify({
...
$(document).on('click', '.hashtag-tag-text', function(e){
    ...
    if (!HashtagOpen) {
        ...
        $.post('http://ctn-phone_new/GetHashtagMessages', JSON.stringify({hashtag: Hashtag}), function(HashtagData){
