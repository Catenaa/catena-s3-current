...
RegisterNetEvent('ctn-phone_new:client:RaceNotify')
AddEventHandler('ctn-phone_new:client:RaceNotify', function(message)
...
RegisterNetEvent('ctn-phone_new:client:AddRecentCall')
AddEventHandler('ctn-phone_new:client:AddRecentCall', function(data, time, type)
    ...
    TriggerServerEvent('ctn-phone:server:SetPhoneAlerts', "phone")
...
RegisterNUICallback('ClearRecentAlerts', function(data, cb)
    TriggerServerEvent('ctn-phone:server:SetPhoneAlerts', "phone", 0)
...
RegisterNUICallback('SetBackground', function(data)
    ...
    TriggerServerEvent('ctn-phone_new:server:SaveMetaData', PhoneData.MetaData)
end)
        ...
        if IsControlJustPressed(0, Config.OpenPhone) then
            if not PhoneData.isOpen then
                ...
                if not IsHandcuffed then
                    ...
                    QBCore.Functions.Notify("The action is not currently possible ..", "error")
                end
            end
        end
        Citizen.Wait(3)
...
Citizen.CreateThread(function()
    while true do
        ...
        if isLoggedIn then
            QBCore.Functions.TriggerCallback('ctn-phone_new:server:GetPhoneData', function(pData)   
...
RegisterNUICallback('HasPhone', function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-phone_new:server:HasPhone', function(HasPhone)
        cb(HasPhone)
    end)
end)
...
function OpenPhone()
    QBCore.Functions.TriggerCallback('ctn-phone_new:server:HasPhone', function(HasPhone)
        if HasPhone then
            ...
            QBCore.Functions.TriggerCallback('ctn-phone_new:server:GetGarageVehicles', function(vehicles)
...
RegisterNetEvent('ctn-phone_new:server:getout')
AddEventHandler('ctn-phone_new:server:getout', function()
    if not PhoneData.CallData.InCall then
        DoPhoneAnimation('cellphone_text_out')
        SetTimeout(400, function()
            StopAnimTask(PlayerPedId(), PhoneData.AnimationData.lib, PhoneData.AnimationData.anim, 2.5)
...
RegisterNUICallback('RemoveMail', function(data, cb)
    ...
    TriggerServerEvent('ctn-phone_new:server:RemoveMail', MailId)
    cb('ok')
end)

RegisterNetEvent('ctn-phone_new:client:UpdateMails')
AddEventHandler('ctn-phone_new:client:UpdateMails', function(NewMails)
    SendNUIMessage({
        action = "UpdateMails",
        Mails = NewMails
    })
...
RegisterNUICallback('AcceptMailButton', function(data)
    ...
    TriggerServerEvent('ctn-phone_new:server:ClearButtonData', data.mailId)
end)
...
RegisterNUICallback('AddNewContact', function(data, cb)
    ...
    TriggerServerEvent('ctn-phone_new:server:AddNewContact', data.ContactName, data.ContactNumber, data.ContactIban)
end)
...
RegisterNUICallback('GetProfilePicture', function(data, cb)
    ...
    QBCore.Functions.TriggerCallback('ctn-phone_new:server:GetPicture', function(picture)
        cb(picture)
    end, number)
end)
...
RegisterNUICallback('SendMessage', function(data, cb)
    ...
    if PhoneData.Chats[NumberKey] ~= nil then
        ...
        if PhoneData.Chats[NumberKey].messages[ChatKey] ~= nil then
            ...
            TriggerServerEvent('ctn-phone_new:server:UpdateMessages', PhoneData.Chats[NumberKey].messages, ChatNumber, false)
            ...
            TriggerServerEvent('ctn-phone_new:server:UpdateMessages', PhoneData.Chats[NumberKey].messages, ChatNumber, true)
            NumberKey = GetKeyByNumber(ChatNumber)
            ReorganizeChats(NumberKey)
        end
    else
    ...
    QBCore.Functions.TriggerCallback('ctn-phone_new:server:GetContactPicture', function(Chat)
        SendNUIMessage({
            action = "UpdateChat",
            chatData = Chat,
...
RegisterNetEvent('ctn-phone_new:client:UpdateMessages')
AddEventHandler('ctn-phone_new:client:UpdateMessages', function(ChatMessages, SenderNumber, New)
    ...
    if New then
        ...
        if PhoneData.isOpen then
            ...
            Wait(100)
            QBCore.Functions.TriggerCallback('ctn-phone_new:server:GetContactPictures', function(Chats)
                SendNUIMessage({
                    action = "UpdateChat",
            ...
            TriggerServerEvent('ctn-phone:server:SetPhoneAlerts', "whatsapp")
        end
    else
...
RegisterNetEvent("ctn-phone-new:client:BankNotify")
AddEventHandler("ctn-phone-new:client:BankNotify", function(text)
    SendNUIMessage({
        action = "Notification",
        NotifyData = {
            title = "Bank", 
...
RegisterNetEvent('ctn-phone_new:client:NewMailNotify')
AddEventHandler('ctn-phone_new:client:NewMailNotify', function(MailData)
    if PhoneData.isOpen then
        SendNUIMessage({
            action = "PhoneNotification",
            PhoneNotify = {
                title = "Mail",
                text = "You have received a new email from "..MailData.sender,
        ...
        SendNUIMessage({
            ...
            NotifyData = {
                title = "Mail", 
                content = "You have received an email from : "..MailData.sender, 
                icon = "fas fa-envelope", 
                timeout = 3500, 
                color = "#ff002f",
            },
    ...
    TriggerServerEvent('ctn-phone:server:SetPhoneAlerts', "mail")
end)

RegisterNUICallback('PostAdvert', function(data)
    TriggerServerEvent('ctn-phone_new:server:AddAdvert', data.message)
end)

RegisterNetEvent('ctn-phone_new:client:UpdateAdverts')
AddEventHandler('ctn-phone_new:client:UpdateAdverts', function(Adverts, LastAd)
    ...
    if PhoneData.isOpen then
        SendNUIMessage({
            ...
            PhoneNotify = {
                title = "Advertisement",
                text = "New announcement from : "..LastAd,
                icon = "fas fa-ad",
                color = "#ff8f1a",
                timeout = 2500,
            },
        ...
        SendNUIMessage({
            ...
            NotifyData = {
                title = "Advertisement", 
                content = "New announcement from :  "..LastAd,
                icon = "fas fa-ad", 
                timeout = 2500, 
                color = "#ff8f1a",
            },
...
RegisterNUICallback('ClearAlerts', function(data, cb)
    ...
    if PhoneData.Chats[ChatKey].Unread ~= nil then
        ...
        TriggerServerEvent('ctn-phone:server:SetPhoneAlerts', "whatsapp", newAlerts)
...
RegisterNUICallback('PayInvoice', function(data, cb)
    ...
    QBCore.Functions.TriggerCallback('ctn-phone_new:server:PayInvoice', function(CanPay, Invoices)
...
RegisterNUICallback('DeclineInvoice', function(data, cb)
    ...
    QBCore.Functions.TriggerCallback('ctn-phone_new:server:DeclineInvoice', function(CanPay, Invoices)
...
RegisterNUICallback('EditContact', function(data, cb)
    ...
    Citizen.Wait(100)
    cb(PhoneData.Contacts)
    TriggerServerEvent('ctn-phone_new:server:EditContact', NewName, NewNumber, NewIban, OldName, OldNumber, OldIban)
end)
...
RegisterNetEvent('ctn-phone_new:client:UpdateHashtags')
AddEventHandler('ctn-phone_new:client:UpdateHashtags', function(Handle, msgData)
...
RegisterNUICallback('PostNewTweet', function(data, cb)
    ...
    for i = 2, #Hashtag, 1 do
        ...
        if Handle ~= nil or Handle ~= "" then
            ...
            TriggerServerEvent('ctn-phone_new:server:UpdateHashtags', Handle, TweetMessage)
        end
    end
        ...
        if Handle ~= nil or Handle ~= "" then
            ...
            if (Firstname ~= nil and Firstname ~= "") and (Lastname ~= nil and Lastname ~= "") then
                if Firstname ~= PhoneData.PlayerData.charinfo.firstname and Lastname ~= PhoneData.PlayerData.charinfo.lastname then
                    TriggerServerEvent('ctn-phone_new:server:MentionedPlayer', Firstname, Lastname, TweetMessage)
                else
    ...
    TriggerServerEvent('ctn-phone_new:server:UpdateTweets', PhoneData.Tweets, TweetMessage)
end)

RegisterNetEvent('ctn-phone_new:client:TransferMoney')
AddEventHandler('ctn-phone_new:client:TransferMoney', function(amount, newmoney)
...
RegisterNetEvent('ctn-phone_new:client:UpdateTweets')
AddEventHandler('ctn-phone_new:client:UpdateTweets', function(src, Tweets, NewTweetData)
...
RegisterNetEvent('ctn-phone_new:client:GetMentioned')
AddEventHandler('ctn-phone_new:client:GetMentioned', function(TweetMessage, AppAlerts)
    Config.PhoneApplications["twitter"].Alerts = AppAlerts
    if not PhoneData.isOpen then
        SendNUIMessage({ action = "Notification", NotifyData = { title = "You were created in the tweet", content = TweetMessage.message, icon = "fab fa-twitter", timeout = 3500, color = nil, }, })
    else
        SendNUIMessage({ action = "PhoneNotification", PhoneNotify = { title = "Mention has been made for you !", text = TweetMessage.message, icon = "fab fa-twitter", color = "#1DA1F2", }, })
    end
...
RegisterNUICallback('ClearMentions', function()
    ...
    TriggerServerEvent('ctn-phone:server:SetPhoneAlerts', "twitter", 0)
    SendNUIMessage({ action = "RefreshAppAlerts", AppData = Config.PhoneApplications })
end)
...
RegisterNUICallback('ClearGeneralAlerts', function(data)
    SetTimeout(400, function()
        ...
        TriggerServerEvent('ctn-phone:server:SetPhoneAlerts', data.app, 0)
        SendNUIMessage({ action = "RefreshAppAlerts", AppData = Config.PhoneApplications })
    end)
end)
...
RegisterNUICallback('TransferMoney', function(data, cb)
    ...
    if tonumber(PhoneData.PlayerData.money.bank) >= data.amount then
        ...
        TriggerServerEvent('ctn-phone_new:server:TransferMoney', data.iban, data.amount)
        local cbdata = {
            CanTransfer = true,
...
RegisterNUICallback('CanTransferMoney', function(data, cb)
    ...
    if (PlayerData.money.bank - amount) >= 0 then
        QBCore.Functions.TriggerCallback('ctn-phone_new:server:CanTransferMoney', function(Transferd)
            if Transferd then
...
RegisterNUICallback('CallContact', function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-phone_new:server:GetCallState', function(CanCall, IsOnline)
        local status = { 
            CanCall = CanCall, 
            IsOnline = IsOnline,
...
CallContact = function(CallData, AnonymousCall)
    ...
    TriggerServerEvent('ctn-phone_new:server:CallContact', PhoneData.CallData.TargetData, PhoneData.CallData.CallId, AnonymousCall)
    TriggerServerEvent('ctn-phone_new:server:SetCallState', true)
...
CancelCall = function()
    TriggerServerEvent('ctn-phone_new:server:CancelCall', PhoneData.CallData)
    ...
    TriggerServerEvent('ctn-phone_new:server:SetCallState', false)
...
RegisterNetEvent('ctn-phone_new:client:CancelCall')
AddEventHandler('ctn-phone_new:client:CancelCall', function()
    if PhoneData.CallData.CallType == "ongoing" then
        SendNUIMessage({
...
RegisterNetEvent('ctn-phone_new:client:GetCalled')
AddEventHandler('ctn-phone_new:client:GetCalled', function(CallerNumber, CallId, AnonymousCall)
    local RepeatCount = 0
    local CallData = {
        number = CallerNumber,
        ...
        if not PhoneData.CallData.AnsweredCall then
            if RepeatCount + 1 ~= Config.CallRepeats + 1 then
                if PhoneData.CallData.InCall then
                    ...
                    TriggerServerEvent('ctn-phone_new:server:AddRecentCall', "missed", CallData)
                    break
                end
                Citizen.Wait(Config.RepeatTimeout)
            else
...
function AnswerCall()
    if (PhoneData.CallData.CallType == "incoming" or PhoneData.CallData.CallType == "outgoing") and PhoneData.CallData.InCall and not PhoneData.CallData.AnsweredCall then
        ...
        TriggerServerEvent('ctn-phone_new:server:AnswerCall', PhoneData.CallData)
        ...
        SendNUIMessage({ 
            ...
            PhoneNotify = { 
                title = "Phone", 
                text = "You do not have an incoming call ...", 
                icon = "fas fa-phone", 
                color = "#e84118", 
            }, 
        })
...
RegisterNetEvent('ctn-phone_new:client:AnswerCall')
AddEventHandler('ctn-phone_new:client:AnswerCall', function()
    if (PhoneData.CallData.CallType == "incoming" or PhoneData.CallData.CallType == "outgoing") and PhoneData.CallData.InCall and not PhoneData.CallData.AnsweredCall then
        PhoneData.CallData.CallType = "ongoing"
        PhoneData.CallData.AnsweredCall = true
        PhoneData.CallData.CallTime = 0
...
RegisterNUICallback('FetchSearchResults', function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-phone_new:server:FetchResult', function(result)
        cb(result)
    end, data.input)
end)

RegisterNUICallback('FetchVehicleResults', function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-phone_new:server:GetVehicleSearchResults', function(result)
        if result ~= nil then 
...
RegisterNUICallback('FetchVehicleScan', function(data, cb)
    ...
    QBCore.Functions.TriggerCallback('ctn-phone_new:server:ScanPlate', function(result)
        QBCore.Functions.TriggerCallback('police:IsPlateFlagged', function(flagged)
...
RegisterNetEvent('ctn-phone:client:addPoliceAlert')
AddEventHandler('ctn-phone:client:addPoliceAlert', function(alertData)
    PlayerJob = QBCore.Functions.GetPlayerData().job
...
RegisterNetEvent('ctn-phone_new:client:GiveContactDetails')
AddEventHandler('ctn-phone_new:client:GiveContactDetails', function()
    local ped = GetPlayerPed(-1)

    local player, distance = GetClosestPlayer()
    if player ~= -1 and distance < 2.5 then
        local PlayerId = GetPlayerServerId(player)
        TriggerServerEvent('ctn-phone_new:server:GiveContactDetails', PlayerId)
    else
...
-- Citizen.CreateThread(function()
--     Wait(1000)
--     TriggerServerEvent('ctn-phone_new:server:GiveContactDetails', 1)
-- end)
...
RegisterNUICallback('DeleteContact', function(data, cb)
        ...
        if v.name == Name and v.number == Number then
            ...
            if PhoneData.isOpen then
                SendNUIMessage({
                    ...
                    PhoneNotify = {
                        title = "Phone",
                        text = "You have removed the contact!", 
                ...
                SendNUIMessage({
                    ...
                    NotifyData = {
                        title = "Phone", 
                        content = "You have removed the contact!", 
                        icon = "fa fa-phone-alt", 
                        timeout = 3500, 
                        color = "#04b543",
                    },
    ...
    TriggerServerEvent('ctn-phone_new:server:RemoveContact', Name, Number)
end)

RegisterNetEvent('ctn-phone_new:client:AddNewSuggestion')
AddEventHandler('ctn-phone_new:client:AddNewSuggestion', function(SuggestionData)
    ...
    Config.PhoneApplications["phone"].Alerts = Config.PhoneApplications["phone"].Alerts + 1
    TriggerServerEvent('ctn-phone:server:SetPhoneAlerts', "phone", Config.PhoneApplications["phone"].Alerts)
end)

RegisterNUICallback('GetCryptoData', function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-crypto:server:GetCryptoData', function(CryptoData)
        cb(CryptoData)
    end, data.crypto)
end)

RegisterNUICallback('BuyCrypto', function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-crypto:server:BuyCrypto', function(CryptoData)
        cb(CryptoData)
    end, data)
end)

RegisterNUICallback('SellCrypto', function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-crypto:server:SellCrypto', function(CryptoData)
        cb(CryptoData)
    end, data)
end)

RegisterNUICallback('TransferCrypto', function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-crypto:server:TransferCrypto', function(CryptoData)
        cb(CryptoData)
    end, data)
end)

RegisterNetEvent('ctn-phone_new:client:RemoveBankMoney')
AddEventHandler('ctn-phone_new:client:RemoveBankMoney', function(amount)
    if PhoneData.isOpen then
        SendNUIMessage({
            action = "PhoneNotification",
            PhoneNotify = {
                title = "Bank",
                text = "exist  $"..amount..",- Debit from your bank!", 
                icon = "fas fa-university", 
                color = "#ff002f",
                timeout = 3500,
            },
        ...
        SendNUIMessage({
            ...
            NotifyData = {
                title = "Bank",
                content = "exist $"..amount..",- Debit from your bank!", 
                icon = "fas fa-university",
                timeout = 3500, 
                color = "#ff002f",
            },
...
RegisterNetEvent('ctn-phone_new:client:AddTransaction')
AddEventHandler('ctn-phone_new:client:AddTransaction', function(SenderData, TransactionData, Message, Title)
    local Data = {
    ...
    TriggerServerEvent('ctn-phone_new:server:AddTransaction', Data)
end)
...
RegisterNUICallback('GetAvailableRaces', function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-lapraces:server:GetRaces', function(Races)
        cb(Races)
    end)
end)

RegisterNUICallback('JoinRace', function(data)
    TriggerServerEvent('ctn-lapraces:server:JoinRace', data.RaceData)
end)

RegisterNUICallback('LeaveRace', function(data)
    TriggerServerEvent('ctn-lapraces:server:LeaveRace', data.RaceData)
end)

RegisterNUICallback('StartRace', function(data)
    TriggerServerEvent('ctn-lapraces:server:StartRace', data.RaceData.RaceId)
end)

RegisterNetEvent('ctn-phone_new:client:UpdateLapraces')
AddEventHandler('ctn-phone_new:client:UpdateLapraces', function()
    SendNUIMessage({
...
RegisterNUICallback('GetRaces', function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-lapraces:server:GetListedRaces', function(Races)
        cb(Races)
    end)
end)

RegisterNUICallback('GetTrackData', function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-lapraces:server:GetTrackData', function(TrackData, CreatorData)
...
RegisterNUICallback('SetupRace', function(data, cb)
    TriggerServerEvent('ctn-lapraces:server:SetupRace', data.RaceId, tonumber(data.AmountOfLaps))
end)

RegisterNUICallback('HasCreatedRace', function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-lapraces:server:HasCreatedRace', function(HasCreated)
        cb(HasCreated)
    end)
end)

RegisterNUICallback('IsInRace', function(data, cb)
    local InRace = exports['ctn-lapraces']:IsInRace()
    cb(InRace)
end)

RegisterNUICallback('IsAuthorizedToCreateRaces', function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-lapraces:server:IsAuthorizedToCreateRaces', function(IsAuthorized, NameAvailable)
        local data = {
            IsAuthorized = IsAuthorized,
            IsBusy = exports['ctn-lapraces']:IsInEditor(),
...
RegisterNUICallback('StartTrackEditor', function(data, cb)
    TriggerServerEvent('ctn-lapraces:server:CreateLapRace', data.TrackName)
end)

RegisterNUICallback('GetRacingLeaderboards', function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-lapraces:server:GetRacingLeaderboards', function(Races)
        cb(Races)
    end)
end)

RegisterNUICallback('RaceDistanceCheck', function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-lapraces:server:GetRacingData', function(RaceData)
        local ped = GetPlayerPed(-1)
        ...
        if dist <= 115.0 then
            if data.Joined then
                TriggerEvent('ctn-lapraces:client:WaitingDistanceCheck')
            end
            cb(true)
        else
            QBCore.Functions.Notify('You are too far from the race. Your navigation is set to race.', 'error', 5000)
...
RegisterNUICallback('IsBusyCheck', function(data, cb)
    if data.check == "editor" then
        cb(exports['ctn-lapraces']:IsInEditor())
    else
        cb(exports['ctn-lapraces']:IsInRace())
    end
end)

RegisterNUICallback('CanRaceSetup', function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-lapraces:server:CanRaceSetup', function(CanSetup)
        cb(CanSetup)
    end)
end)

RegisterNUICallback('GetPlayerHouses', function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-phone_new:server:GetPlayerHouses', function(Houses)
        cb(Houses)
    end)
end)

RegisterNUICallback('GetPlayerKeys', function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-phone_new:server:GetHouseKeys', function(Keys)
        cb(Keys)
    end)
end)
...
RegisterNUICallback('SetHouseLocation', function(data, cb)
    ...
    QBCore.Functions.Notify("Your location has been determined ! " .. data.HouseData.HouseData.adress .. "!", "success")
end)

RegisterNUICallback('RemoveKeyholder', function(data)
    TriggerServerEvent('ctn-houses:server:removeHouseKey', data.HouseData.name, {
...
RegisterNUICallback('TransferCid', function(data, cb)
    ...
    QBCore.Functions.TriggerCallback('ctn-phone_new:server:TransferCid', function(CanTransfer)
        cb(CanTransfer)
    end, TransferedCid, data.HouseData)
end)

RegisterNUICallback('FetchPlayerHouses', function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-phone_new:server:MeosGetPlayerHouses', function(result)
        cb(result)
    end, data.input)
end)
...
RegisterNUICallback('SetApartmentLocation', function(data, cb)
    ...
    QBCore.Functions.Notify('The location has been determined !', 'success')
end)

RegisterNUICallback('GetCurrentLawyers', function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-phone_new:server:GetCurrentLawyers', function(lawyers)
        cb(lawyers)
    end)
end)


RegisterNetEvent('ctn-phone_new:client:toclientcallcenter')
AddEventHandler('ctn-phone_new:client:toclientcallcenter', function()
    TriggerServerEvent('ctn-phone_new:server:emergencylineadd')
end)

RegisterNUICallback('GetCurrentEmergency', function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-phone_new:server:GetCurrentEmergency', function(Emergencya)
        cb(Emergencya)
    end)
end)

RegisterNUICallback('GetCurrentTaxi', function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-phone_new:server:GetCurrentTaxi', function(taxi)
        cb(taxi)
    end)
end)

RegisterNUICallback('GetCurrentTow', function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-phone_new:server:GetCurrentTow', function(tow)
        cb(tow)
    end)
end)

RegisterNUICallback('GetCurrentMech', function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-phone_new:server:GetCurrentMech', function(mech)
        cb(mech)
    end)
end)
...
RegisterNUICallback('InstallApplication', function(data, cb)
   ...
   -- end
	...
	print('test ')
        TriggerServerEvent('ctn-phone_new:server:InstallApplication', {
            app = data.app,
        })
        cb({
            app = data.app,
...
RegisterNUICallback('RemoveApplication', function(data, cb)
    TriggerServerEvent('ctn-phone_new:server:RemoveInstallation', data.app)
end)

RegisterNetEvent('ctn-phone_new:RefreshPhone')
AddEventHandler('ctn-phone_new:RefreshPhone', function()
    LoadPhone()
    SetTimeout(250, function()
        SendNUIMessage({
...
RegisterNUICallback('GetTruckerData', function(data, cb)
    ...
    local TierData = exports['ctn-trucker']:GetTier(TruckerMeta)
    cb(TierData)
end)
