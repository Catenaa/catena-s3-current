...
QBCore.Functions.CreateCallback('ctn-spawn:server:getOwnedHouses', function(source, cb, cid)
	if cid ~= nil then
...
-- 	TriggerClientEvent('ctn-spawn:client:setupSpawns', src, Player, false, {})
-- 	TriggerClientEvent('ctn-spawn:client:openUI', src, true)
-- end)