...
RegisterServerEvent("ctn-hud:Server:UpdateStress")
AddEventHandler('ctn-hud:Server:UpdateStress', function(StressGain)
	local src = source
...
RegisterServerEvent('ctn-hud:Server:GainStress')
AddEventHandler('ctn-hud:Server:GainStress', function(amount)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local newStress
    if Player ~= nil then
...
RegisterServerEvent('ctn-hud:Server:RelieveStress')
AddEventHandler('ctn-hud:Server:RelieveStress', function(amount)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local newStress
    if Player ~= nil then
