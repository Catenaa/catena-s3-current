...
RegisterNetEvent('ctn-phone:client:RaceNotify')
AddEventHandler('ctn-phone:client:RaceNotify', function(message)
...
RegisterNetEvent('ctn-phone:client:AddRecentCall')
AddEventHandler('ctn-phone:client:AddRecentCall', function(data, time, type)
...
RegisterNUICallback('SetBackground', function(data)
    ...
    TriggerServerEvent('ctn-phone:server:SaveMetaData', PhoneData.MetaData)
end)
...
Citizen.CreateThread(function()
    while true do
        ...
        if isLoggedIn then
            QBCore.Functions.TriggerCallback('ctn-phone:server:GetPhoneData', function(pData)   
...
RegisterNUICallback('HasPhone', function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-phone:server:HasPhone', function(HasPhone)
        cb(HasPhone)
    end)
end)
...
function OpenPhone()
    QBCore.Functions.TriggerCallback('ctn-phone:server:HasPhone', function(HasPhone)
        if HasPhone then
            ...
            QBCore.Functions.TriggerCallback('ctn-phone:server:GetGarageVehicles', function(vehicles)
...
RegisterNUICallback('RemoveMail', function(data, cb)
    ...
    TriggerServerEvent('ctn-phone:server:RemoveMail', MailId)
    cb('ok')
end)

RegisterNetEvent('ctn-phone:client:UpdateMails')
AddEventHandler('ctn-phone:client:UpdateMails', function(NewMails)
    SendNUIMessage({
        action = "UpdateMails",
        Mails = NewMails
    })
...
RegisterNUICallback('AcceptMailButton', function(data)
    ...
    TriggerServerEvent('ctn-phone:server:ClearButtonData', data.mailId)
end)

CallDriverTimer = GetGameTimer()-15000
RegisterNetEvent('ctn-phone:client:AddTaxiCall')
AddEventHandler('ctn-phone:client:AddTaxiCall', function(id, data)
...
RegisterNetEvent('ctn-phone:client:RemoveTaxiCall')
AddEventHandler('ctn-phone:client:RemoveTaxiCall', function(id)
    if PlayerJob.name ~= 'taxi' then
        return
    end
...
RegisterNetEvent('ctn-phone:client:AcceptDriverCall')
AddEventHandler('ctn-phone:client:AcceptDriverCall', function(data)
    if PlayerJob.name ~= 'taxi' then
        return
    end
...
RegisterNUICallback('AcceptTaxiCall', function(data, cb)
    ...
    TriggerServerEvent("ctn-phone:server:AcceptDriverCall", tonumber(data.id))
end)
...
RegisterNUICallback('CallDriver', function(data, cb)
    ...
    TriggerServerEvent('ctn-phone:server:CallDriver', { x = coords, y = coords.y, z = coords.z })
...
RegisterNUICallback('AddNewContact', function(data, cb)
    ...
    TriggerServerEvent('ctn-phone:server:AddNewContact', data.ContactName, data.ContactNumber, data.ContactIban)
end)
...
RegisterNUICallback('GetProfilePicture', function(data, cb)
    ...
    QBCore.Functions.TriggerCallback('ctn-phone:server:GetPicture', function(picture)
        cb(picture)
    end, number)
end)
...
RegisterNUICallback('SendMessage', function(data, cb)
    ...
    if PhoneData.Chats[NumberKey] ~= nil then
        ...
        if PhoneData.Chats[NumberKey].messages[ChatKey] ~= nil then
            ...
            TriggerServerEvent('ctn-phone:server:UpdateMessages', PhoneData.Chats[NumberKey].messages, ChatNumber, false)
            ...
            TriggerServerEvent('ctn-phone:server:UpdateMessages', PhoneData.Chats[NumberKey].messages, ChatNumber, true)
            NumberKey = GetKeyByNumber(ChatNumber)
            ReorganizeChats(NumberKey)
        end
    else
    ...
    QBCore.Functions.TriggerCallback('ctn-phone:server:GetContactPicture', function(Chat)
        SendNUIMessage({
            action = "UpdateChat",
            chatData = Chat,
...
RegisterNetEvent('ctn-phone:client:UpdateMessages')
AddEventHandler('ctn-phone:client:UpdateMessages', function(ChatMessages, SenderNumber, New)
    ...
    if New then
        ...
        if PhoneData.isOpen then
            ...
            Wait(100)
            QBCore.Functions.TriggerCallback('ctn-phone:server:GetContactPictures', function(Chats)
                SendNUIMessage({
                    action = "UpdateChat",
...
RegisterNetEvent('ctn-phone:client:NewMailNotify')
AddEventHandler('ctn-phone:client:NewMailNotify', function(MailData)
...
RegisterNUICallback('PostAdvert', function(data)
    ...
    TriggerServerEvent('ctn-phone:server:AddAdvert', data.message)
end)

RegisterNetEvent('ctn-phone:client:UpdateAdverts')
AddEventHandler('ctn-phone:client:UpdateAdverts', function(Adverts, LastAd)
...
RegisterNUICallback('PayInvoice', function(data, cb)
    ...
    QBCore.Functions.TriggerCallback('ctn-phone:server:PayInvoice', function(CanPay, Invoices)
...
RegisterNUICallback('DeclineInvoice', function(data, cb)
    ...
    QBCore.Functions.TriggerCallback('ctn-phone:server:DeclineInvoice', function(CanPay, Invoices)
...
RegisterNUICallback('EditContact', function(data, cb)
    ...
    Citizen.Wait(100)
    cb(PhoneData.Contacts)
    TriggerServerEvent('ctn-phone:server:EditContact', NewName, NewNumber, NewIban, OldName, OldNumber, OldIban)
end)
...
RegisterNetEvent('ctn-phone:client:UpdateHashtags')
AddEventHandler('ctn-phone:client:UpdateHashtags', function(Handle, msgData)
...
RegisterNUICallback('PostNewTweet', function(data, cb)
    ...
    for i = 2, #Hashtag, 1 do
        ...
        if Handle ~= nil or Handle ~= "" then
            ...
            TriggerServerEvent('ctn-phone:server:UpdateHashtags', Handle, TweetMessage)
        end
    end
        ...
        if Handle ~= nil or Handle ~= "" then
            ...
            if (Firstname ~= nil and Firstname ~= "") and (Lastname ~= nil and Lastname ~= "") then
                if Firstname ~= PhoneData.PlayerData.charinfo.firstname and Lastname ~= PhoneData.PlayerData.charinfo.lastname then
                    TriggerServerEvent('ctn-phone:server:MentionedPlayer', Firstname, Lastname, TweetMessage)
                else
    ...
    TriggerServerEvent('ctn-phone:server:UpdateTweets', PhoneData.Tweets, TweetMessage)
end)

RegisterNetEvent('ctn-phone:client:TransferMoney')
AddEventHandler('ctn-phone:client:TransferMoney', function(amount, newmoney)
...
RegisterNetEvent('ctn-phone:client:UpdateTweets')
AddEventHandler('ctn-phone:client:UpdateTweets', function(src, Tweets, NewTweetData)
...
RegisterNetEvent('ctn-phone:client:GetMentioned')
AddEventHandler('ctn-phone:client:GetMentioned', function(TweetMessage, AppAlerts)
...
RegisterNUICallback('TransferMoney', function(data, cb)
    ...
    if tonumber(PhoneData.PlayerData.money.bank) >= data.amount then
        ...
        TriggerServerEvent('ctn-phone:server:TransferMoney', data.iban, data.amount)
        local cbdata = {
            CanTransfer = true,
...
RegisterNUICallback('CanTransferMoney', function(data, cb)
    ...
    if (PlayerData.money.bank - amount) >= 0 then
        QBCore.Functions.TriggerCallback('ctn-phone:server:CanTransferMoney', function(Transferd)
            if Transferd then
...
RegisterNUICallback('CallContact', function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-phone:server:GetCallState', function(CanCall, IsOnline)
        local status = { 
            CanCall = CanCall, 
            IsOnline = IsOnline,
...
CallContact = function(CallData, AnonymousCall)
    ...
    TriggerServerEvent('ctn-phone:server:CallContact', PhoneData.CallData.TargetData, PhoneData.CallData.CallId, AnonymousCall)
    TriggerServerEvent('ctn-phone:server:SetCallState', true)
...
CancelCall = function()
    TriggerServerEvent('ctn-phone:server:CancelCall', PhoneData.CallData)
    ...
    TriggerServerEvent('ctn-phone:server:SetCallState', false)
...
RegisterNetEvent('ctn-phone:client:CancelCall')
AddEventHandler('ctn-phone:client:CancelCall', function()
...
RegisterNetEvent('ctn-phone:client:GetCalled')
AddEventHandler('ctn-phone:client:GetCalled', function(CallerNumber, CallId, AnonymousCall)
        ...
        if not PhoneData.CallData.AnsweredCall then
            if RepeatCount + 1 ~= Config.CallRepeats + 1 then
                if PhoneData.CallData.InCall then
                    ...
                    TriggerServerEvent('ctn-phone:server:AddRecentCall', "missed", CallData)
                    break
                end
                Citizen.Wait(Config.RepeatTimeout)
            else
...
function AnswerCall()
    if (PhoneData.CallData.CallType == "incoming" or PhoneData.CallData.CallType == "outgoing") and PhoneData.CallData.InCall and not PhoneData.CallData.AnsweredCall then
        ...
        TriggerServerEvent('ctn-phone:server:AnswerCall', PhoneData.CallData)
...
RegisterNetEvent('ctn-phone:client:AnswerCall')
AddEventHandler('ctn-phone:client:AnswerCall', function()
...
RegisterNUICallback('FetchSearchResults', function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-phone:server:FetchResult', function(result)
        cb(result)
    end, data.input)
end)

RegisterNUICallback('SetupSellix', function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-pawnshop:server:getSellixList', function(boolz, dataz)
        if boolz == false then
            cb('banned')
        else
            cb(dataz)
...
RegisterNUICallback('ActivateBuyer', function(data, cb)
    if exports['ctn-pawnshop']:hasActiveDelivery() == true then
        cb(1)
        return
    end

    QBCore.Functions.TriggerCallback('ctn-pawnshop:server:takeOffer', function(boolz, dataz)
        if boolz == true then
            TriggerServerEvent('ctn-phone:server:sendNewMail', {
                sender = "Sellix Store",
...
RegisterNUICallback('FetchVehicleResults', function(data, cb)
    QBCore.Functions.TriggerCallback('ctn-phone:server:GetVehicleSearchResults', function(result)
        if result ~= nil then 
...
RegisterNUICallback('FetchVehicleScan', function(data, cb)
    ...
    QBCore.Functions.TriggerCallback('ctn-phone:server:ScanPlate', function(result)
        QBCore.Functions.TriggerCallback('police:IsPlateFlagged', function(flagged)
...
RegisterNetEvent('ctn-phone:client:GiveContactDetails')
AddEventHandler('ctn-phone:client:GiveContactDetails', function()
    local ped = GetPlayerPed(-1)

    local player, distance = GetClosestPlayer()
    if player ~= -1 and distance < 2.5 then
        local PlayerId = GetPlayerServerId(player)
        TriggerServerEvent('ctn-phone:server:GiveContactDetails', PlayerId)
...
RegisterNUICallback('DeleteContact', function(data, cb)
    ...
    TriggerServerEvent('ctn-phone:server:RemoveContact', Name, Number)
end)

RegisterNetEvent('ctn-phone:client:AddNewSuggestion')
AddEventHandler('ctn-phone:client:AddNewSuggestion', function(SuggestionData)
...
RegisterNetEvent('ctn-phone:client:RemoveBankMoney')
AddEventHandler('ctn-phone:client:RemoveBankMoney', function(amount)
...
RegisterNetEvent('ctn-phone:client:AddTransaction')
AddEventHandler('ctn-phone:client:AddTransaction', function(SenderData, TransactionData, Message, Title)
    ...
    TriggerServerEvent('ctn-phone:server:AddTransaction', Data)
end)
...
RegisterNetEvent('ctn-phone:client:UpdateLapraces')
AddEventHandler('ctn-phone:client:UpdateLapraces', function()
...
RegisterNUICallback('GetPlayerHouses', function(data, cb)
    ...
    QBCore.Functions.TriggerCallback('ctn-phone:server:GetPlayerHouses', function(Houses)
...
RegisterNUICallback('GetPlayerKeys', function(data, cb)
    ...
    QBCore.Functions.TriggerCallback('ctn-phone:server:GetHouseKeys', function(Keys)
...
RegisterNUICallback('TransferCid', function(data, cb)
    ...
    QBCore.Functions.TriggerCallback('ctn-phone:server:TransferCid', function(CanTransfer)
        cb(CanTransfer)
...
RegisterNUICallback('FetchPlayerHouses', function(data, cb)
    ...
    QBCore.Functions.TriggerCallback('ctn-phone:server:MeosGetPlayerHouses', function(result)
        cb(result)
    end, data.input)
end)
...
RegisterNUICallback('GetCurrentLawyers', function(data, cb)
    ...
    QBCore.Functions.TriggerCallback('ctn-phone:server:GetCurrentLawyers', function(lawyers)
        cb(lawyers)
    end)
end)
...
RegisterNUICallback('GetCurrentDrivers', function(data, cb)
    ...
    QBCore.Functions.TriggerCallback('ctn-phone:server:GetCurrentDrivers', function(drivers, isTaxi)
...
RegisterNUICallback('InstallApplication', function(data, cb)
    ...
    if NewSlot <= Config.MaxSlots then
        TriggerServerEvent('ctn-phone:server:InstallApplication', {
            app = data.app,
        })
        cb({
            app = data.app,
...
RegisterNUICallback('RemoveApplication', function(data, cb)
    ...
    TriggerServerEvent('ctn-phone:server:RemoveInstallation', data.app)
end)

RegisterNetEvent('ctn-phone:RefreshPhone')
AddEventHandler('ctn-phone:RefreshPhone', function()
...
RegisterNUICallback('OpenCamera', function(data, cb)
    TriggerServerEvent('qb-phone:server:OpenCamera')
end)
