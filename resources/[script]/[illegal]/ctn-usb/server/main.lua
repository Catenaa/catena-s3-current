...
AddEventHandler("Drugs:startHackTimer",function(source)
    table.insert(PlayerHackTimer,{started = GetPlayerIdentifier(source), time = 900000}) -- cooldown timer for using USB stick
end)
...
QBCore.Functions.CreateUseableItem('methburn', function(source, item)
    if not CheckedStarted(GetPlayerIdentifier(source)) then
        ...
        TriggerEvent('ctn-logs:server:createLog', 'usb', 'Meth USB Used', "", source)
...
QBCore.Functions.CreateUseableItem('cokeburn', function(source, item)
    if not CheckedStarted(GetPlayerIdentifier(source)) then
        ...
        TriggerEvent("Drugs:startHackTimer",source)
        TriggerEvent('ctn-logs:server:createLog', 'usb', 'Coke USB Used', "", source)
        TriggerClientEvent("Drugs:UsableItem",source)
        Citizen.Wait(8000)
        TriggerClientEvent("Drugs:HackingMiniGame",source)
...
QBCore.Functions.CreateUseableItem('weedburn', function(source, item)
    if not CheckedStarted(GetPlayerIdentifier(source)) then
        local xPlayer = QBCore.Functions.GetPlayer(source)
        xPlayer.Functions.RemoveItem('weedburn', 1)
        TriggerEvent("Drugs:startHackTimer",source)
        TriggerEvent('ctn-logs:server:createLog', 'usb', 'Weed USB Used', "", source)
        TriggerClientEvent("Drugs:UsableItem",source)
        Citizen.Wait(8000)
        TriggerClientEvent("Drugs:HackingMiniGame",source)
...
QBCore.Functions.CreateUseableItem('goldenburn', function(source, item)
    if not CheckedStarted(GetPlayerIdentifier(source)) then
        local xPlayer = QBCore.Functions.GetPlayer(source)
        xPlayer.Functions.RemoveItem('goldenburn', 1)
        TriggerEvent("Drugs:startHackTimer", source)
        local selected = string.gsub(Config.Items.items[math.random(1, 3)].name, "burn", "")
        TriggerEvent('ctn-logs:server:createLog', 'usb', 'Golden USB Used', "**[Random Type]** " .. selected, source)
        TriggerClientEvent("Drugs:UsableItem", source)
        Citizen.Wait(8000)
        TriggerClientEvent("Drugs:HackingMiniGame",source)
