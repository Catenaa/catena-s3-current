...
addEventListener("message", function(event){
    ...
    if(item.open == true) {
        ...
        $.post('http://ctn-bossmenu/closeNUI');
    }
});
...
$(document).on('click', '.fireemployee', function(e) {
    ...
    $.post('http://ctn-bossmenu/fireEmployee', JSON.stringify({
        source: playerid,
    }));
});
...
$(document).on('click', '.grade-box', function(e) {
    ...
    $.post('http://ctn-bossmenu/changeGrade', JSON.stringify({
        grade: gradeid,
...
$(document).on('click', '#option-recruit', function(e) {
    ...
    $.post('http://ctn-bossmenu/openRecruit', JSON.stringify({}));
});

$(document).on('click', '#option-bosstash', function(e) {

    $.post('http://ctn-bossmenu/openStash', JSON.stringify({}));
});
...
$(document).on('click', '.givejob', function(e) {
    ...
    $.post('http://ctn-bossmenu/giveJob', JSON.stringify({
        source: playerid,
    }));
});
...
$(document).on('click', '.deposit', function(e) {
    $.post('http://ctn-bossmenu/deposit', JSON.stringify({
        amount: currentDepositAmount,
    }));
});

$(document).on('click', '.withdraw', function(e) {
    $.post('http://ctn-bossmenu/withdraw', JSON.stringify({
