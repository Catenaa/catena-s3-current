...
RegisterNetEvent('ctn-bossmenu:client:openMenu')
AddEventHandler('ctn-bossmenu:client:openMenu', function(employees, jobdata)
...
RegisterNetEvent('ctn-bossmenu:client:refreshPage')
AddEventHandler('ctn-bossmenu:client:refreshPage', function(data, list)
...
RegisterNetEvent('ctn-bossmenu:client:refreshSociety')
AddEventHandler('ctn-bossmenu:client:refreshSociety', function(job, data)
...
RegisterNUICallback('giveJob', function(data)
    TriggerServerEvent('ctn-bossmenu:server:giveJob', data)
end)
...
RegisterNUICallback('openRecruit', function(data)
    CreateThread(function()
        ...
        TriggerServerEvent("ctn-bossmenu:server:updateNearbys", players)
    end)
end)

RegisterNUICallback('changeGrade', function(data)
    TriggerServerEvent('ctn-bossmenu:server:updateGrade', data)
end)

RegisterNUICallback('fireEmployee', function(data)
    TriggerServerEvent('ctn-bossmenu:server:fireEmployee', data)
end)
...
RegisterNUICallback('withdraw', function(data)
    ...
    TriggerServerEvent("ctn-bossmenu:server:withdrawMoney", amount)
end)

RegisterNUICallback('deposit', function(data)
    local amount = tonumber(data.amount)
    TriggerServerEvent("ctn-bossmenu:server:depositMoney", amount)
end)
