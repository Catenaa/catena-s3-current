...
RegisterNetEvent("ctn-dices:ToggleDisplay")
AddEventHandler("ctn-dices:ToggleDisplay", function(playerId, number, typ)
...
RegisterNetEvent("ctn-scripts:client:locationChange")
AddEventHandler("ctn-scripts:client:locationChange", function(typ)
    TriggerServerEvent('ctn-scripts:locationChange:' .. typ)
end)

RegisterNetEvent("ctn-dices:ToggleDiceAnim")
AddEventHandler("ctn-dices:ToggleDiceAnim", function()
