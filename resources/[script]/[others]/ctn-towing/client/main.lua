...
RegisterNetEvent('ctn-tow:client:ImpoundVehicle')
AddEventHandler('ctn-tow:client:ImpoundVehicle', function()
    ...
    if DoesEntityExist(targetVehicle) then
        ...
        QBCore.Functions.Progressbar("impound", "Impounding", 6000, false, true, {
            ...
            QBCore.Functions.Notify("Impounded!", "success")
...
RegisterNetEvent('ctn-tow:client:TowVehicle')
AddEventHandler('ctn-tow:client:TowVehicle', function()
    ...
    if isTowVehicle(vehicle) then 
        if CurrentTow == nil then 
            ...
            QBCore.Functions.Progressbar("untowing_vehicle", "Untowing Vehicle", 5000, false, true, {
                disableMovement = true,
                disableCarMovement = true,
                disableMouse = false,
                disableCombat = true,
                ...
                CurrentTow = nil
                QBCore.Functions.Notify("Vehicle tackled!")
            end, function() -- Cancel
                StopAnimTask(GetPlayerPed(-1), "mini@repair", "fixing_a_ped", 1.0)
                QBCore.Functions.Notify("Failed!", "error")
            end)
        ...
        QBCore.Functions.Notify("You must sit in the flatbed before you attempt to tow a vehicle.", "error")
    end
end)
