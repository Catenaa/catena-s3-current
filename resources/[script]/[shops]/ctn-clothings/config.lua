...
Config.ClothingRooms = {
    [1] = {requiredJob = "police", x = 451.58, y = -993.28, z = 30.68, cameraLocation = {x = 451.589, y = -993.289, z = 30.68, h = 5.397}},
    ...
    [4] = {requiredJob = "gendarme", x = 1839.74, y = 3689.56, z = 34.31, cameraLocation = {x = -451.46, y = 6014.25, z = 31.72}},
    [5] = {requiredJob = "ambulance", x = -250.5, y = 6323.98, z = 32.32, cameraLocation = {x = -250.5, y = 6323.98, z = 32.32, h = 315.5}},    
    [6] = {requiredJob = "mechanic", x = -207.5, y = -1337.98, z = 34.52, cameraLocation = {x = -210.5, y = -1338.28, z = 35.32, h = 264.5}}, 
}
...
Config.Outfits = {
        ...
        ["male"] = {
            [1] = {
                ...
                outfitData = {
                    ...
                    ["arms"]        = { item = 34, texture = 0},  -- Armen
                    ["t-shirt"]     = { item = 91, texture = 0},  -- T Shirt
                    ["vest"]        = { item = 53, texture = 0},  -- Body Vest
                    ["torso2"]      = { item = 19, texture = 10},  -- Jas / Vesten
                    ["shoes"]       = { item = 32, texture = 0},  -- Schoenen
        ...
        ["male"] = {
            [1] = {
                ...
                outfitData = {
                    ...
                    ["shoes"]       = { item = 32, texture = 0},  -- Schoenen
                    ["decals"]      = { item = 0, texture = 0},  -- Decals
                    ["accessory"]   = { item = 17, texture = 0},  -- Nek / Das
            --      ["bag"]         = { item = 0, texture = 0},  -- Tas
                    ["hat"]         = { item = -1, texture = -1},  -- Pet
            --      ["glass"]       = { item = 0, texture = 0},  -- Bril
            --      ["ear"]         = { item = 0, texture = 0},  -- Oor accessoires
            ...
            [2] = {
                outfitLabel = "Officier",
                outfitData = {
                    ["pants"]       = { item = 32, texture = 0},  -- Broek
                    ["arms"]        = { item = 4, texture = 0},  -- Armen
                    ["t-shirt"]     = { item = 57, texture = 0},  -- T Shirt
                    ["vest"]        = { item = 3, texture = 22},  -- Body Vest
                    ["torso2"]      = { item = 19, texture = 11},  -- Jas / Vesten
                    ["shoes"]       = { item = 32, texture = 0},  -- Schoenen
                    ["decals"]      = { item = 0, texture = 0},  -- Decals
                    ["accessory"]   = { item = 17, texture = 0},  -- Nek / Das
            --      ["bag"]         = { item = 0, texture = 0},  -- Tas
            ...
            [3] = {
                ...
                outfitData = {
                    ...
                    ["arms"]        = { item = 40, texture = 0},  -- Armen
                    ["t-shirt"]     = { item = 57, texture = 0},  -- T Shirt
                    ["vest"]        = { item = 22, texture = 3},  -- Body Vest
                    ["torso2"]      = { item = 84, texture = 8},  -- Jas / Vesten
                    ["shoes"]       = { item = 32, texture = 0},  -- Schoenen
                    ["decals"]      = { item = 0, texture = 0},  -- Decals
            ...
            [4] = {
                ...
                outfitData = {
                    ...
                    ["arms"]        = { item = 4, texture = 0},  -- Armen
                    ["t-shirt"]     = { item = 39, texture = 2},  -- T Shirt
                    ["vest"]        = { item = 28, texture = 5},  -- Body Vest
                    ["torso2"]      = { item = 23, texture = 2},  -- Jas / Vesten
                    ["shoes"]       = { item = 32, texture = 0},  -- Schoenen
                    ["decals"]      = { item = 0, texture = 0},  -- Decals
                    ["accessory"]   = { item = 138, texture = 0},  -- Nek / Das
            --      ["bag"]         = { item = 0, texture = 0},  -- Tas
                    ["hat"]         = { item = -1, texture = -1},  -- Pet
            --      ["glass"]       = { item = 0, texture = 0},  -- Bril
            --      ["ear"]         = { item = 0, texture = 0},  -- Oor accessoires
            ...
            [5] = {
                ...
                outfitData = {
                    ...
                    ["t-shirt"]     = { item = 57, texture = 0},  -- T Shirt
                    ["vest"]        = { item = 0, texture = 0},  -- Body Vest
                    ["torso2"]      = { item = 19, texture = 17},  -- Jas / Vesten
                    ["shoes"]       = { item = 32, texture = 0},  -- Schoenen
                    ["decals"]      = { item = 0, texture = 0},  -- Decals
                    ["accessory"]   = { item = 17, texture = 0},  -- Nek / Das
            --      ["bag"]         = { item = 0, texture = 0},  -- Tas
    ...
    ["police"] = {
        ["male"] = {
            [1] = {
                outfitLabel = "Gardien de la paix",
                outfitData = {
                    ["pants"]       = { item = 18, texture = 0},  -- Broek
                    ["arms"]        = { item = 0, texture = 0},  -- Armen
                    ["t-shirt"]     = { item = 28, texture = 0},  -- T Shirt
                    ["vest"]        = { item = 0, texture = 0},  -- Body Vest
                    ["torso2"]      = { item = 124, texture = 0},  -- Jas / Vesten
                    ["shoes"]       = { item = 35, texture = 0},  -- Schoenen
                    ["decals"]      = { item = 0, texture = 0},  -- Decals
                    ["accessory"]   = { item = 18, texture = 0},  -- Nek / Das
            --      ["bag"]         = { item = 0, texture = 0},  -- Tas
                    ["hat"]         = { item = -1, texture = -1},  -- Pet
            --      ["glass"]       = { item = 0, texture = 0},  -- Bril
            --      ["ear"]         = { item = 0, texture = 0},  -- Oor accessoires
            ...
            [3] = {
                outfitLabel = "Officier de la paix",
                outfitData = {
                    ["pants"]       = { item = 10, texture = 0},  -- Broek
                    ["arms"]        = { item = 0, texture = 0},  -- Armen
                    ["t-shirt"]     = { item = 166, texture = 0},  -- T Shirt
                    ["vest"]        = { item = 0, texture = 0},  -- Body Vest
                    ["torso2"]      = { item = 191, texture = 0},  -- Jas / Vesten
                    ["shoes"]       = { item = 10, texture = 0},  -- Schoenen
                    ["decals"]      = { item = 0, texture = 0},  -- Decals
                    ["accessory"]   = { item = 16, texture = 0},  -- Nek / Das
            --      ["bag"]         = { item = 0, texture = 0},  -- Tas
            ...
            [4] = {
                outfitLabel = "Inspecteur de police",
                outfitData = {
                    ["pants"]       = { item = 8, texture = 0},  -- Broek
                    ["arms"]        = { item = 0, texture = 0},  -- Armen
                    ["t-shirt"]     = { item = 166, texture = 0},  -- T Shirt
                    ["vest"]        = { item = 50, texture = 3},  -- Body Vest
                    ["torso2"]      = { item = 51, texture = 1},  -- Jas / Vesten
                    ["shoes"]       = { item = 21, texture = 3},  -- Schoenen
                    ["decals"]      = { item = 0, texture = 0},  -- Decals
                    ["accessory"]   = { item = 0, texture = 0},  -- Nek / Das
            --      ["bag"]         = { item = 0, texture = 0},  -- Tas
                    ["hat"]         = { item = -1, texture = -1},  -- Pet
            ...
            [5] = {
                outfitLabel = "Préfet de police",
                outfitData = {
                    ["pants"]       = { item = 10, texture = 2},  -- Broek
                    ["arms"]        = { item = 0, texture = 0},  -- Armen
                    ["t-shirt"]     = { item = 25, texture = 6},  -- T Shirt
                    ["vest"]        = { item = 0, texture = 0},  -- Body Vest
                    ["torso2"]      = { item = 126, texture = 2},  -- Jas / Vesten
                    ["shoes"]       = { item = 31, texture = 0},  -- Schoenen
                    ["decals"]      = { item = 0, texture = 0},  -- Decals
                    ["accessory"]   = { item = 0, texture = 0},  -- Nek / Das
            --      ["bag"]         = { item = 0, texture = 0},  -- Tas
                    ["hat"]         = { item = -1, texture = -1},  -- Pet
    ...
    ["doctor"] = {
        ["male"] = {
            [1] = {
                outfitLabel = "Jacket For Doctors",
                outfitData = {
                    ["pants"]       = { item = 49,texture = 0},  -- Broek
                    ["arms"]        = { item = 86, texture = 0},  -- Armen
                    ["t-shirt"]     = { item = 88, texture = 0},  -- T Shirt
			...
			[3] = {
                outfitLabel = "Helicopter Outfit1",
                outfitData = {
                    ["pants"]       = { item = 59,texture = 5},  -- Broek
                    ["arms"]        = { item = 86, texture = 0},  -- Armen
                    ["t-shirt"]     = { item = 135, texture = 0},  -- T Shirt
			...
			[4] = {
                outfitLabel = "Helicopter Outfit2",
                outfitData = {
                    ["pants"]       = { item = 59,texture = 5},  -- Broek
                    ["arms"]        = { item = 86, texture = 0},  -- Armen
                    ["t-shirt"]     = { item = 135, texture = 0},  -- T Shirt
			...
			[5] = {
                outfitLabel = "Helicopter Outfit3",
                outfitData = {
                    ["pants"]       = { item = 59,texture = 5},  -- Broek
                    ["arms"]        = { item = 86, texture = 0},  -- Armen
                    ["t-shirt"]     = { item = 135, texture = 0},  -- T Shirt
