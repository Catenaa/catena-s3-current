...
CreateThread(function()
	Wait(2500)
	QBCore.Functions.TriggerCallback('ctn-sellveh:getlist', function(isOwner)
		ActiveSells = isOwner
	end)
end)
...
RegisterNetEvent('ctn-sellveh:client:publicsale:updateList')
AddEventHandler('ctn-sellveh:client:publicsale:updateList', function(data)
	ActiveSells[data[5]] = data
end)

RegisterNetEvent('ctn-sellveh:client:publicsale:removeList')
AddEventHandler('ctn-sellveh:client:publicsale:removeList', function(key, stock)
