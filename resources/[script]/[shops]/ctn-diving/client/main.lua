...
AddEventHandler("QBCore:Client:OnPlayerLoaded", function()
    QBCore.Functions.TriggerCallback('ctn-diving:server:GetBusyDocks', function(Docks)
...
RegisterNetEvent('ctn-diving:client:UseJerrycan')
AddEventHandler('ctn-diving:client:UseJerrycan', function()
    ...
    if boat then
        ...
        QBCore.Functions.Progressbar("reful_boat", "Refueling boat..", 20000, false, true, {
            ...
            TriggerServerEvent('ctn-diving:server:RemoveItem', 'jerry_can', 1)
