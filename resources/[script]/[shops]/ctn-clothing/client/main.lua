...
AddEventHandler('QBCore:Client:OnPlayerLoaded', function()
    TriggerServerEvent("ctn-clothes:loadPlayerSkin")
...
RegisterNetEvent('ctn-clothing:client:openOutfitMenu')
AddEventHandler('ctn-clothing:client:openOutfitMenu', function()
    QBCore.Functions.TriggerCallback('ctn-clothing:server:getOutfits', function(result)
        openMenu({
...
RegisterNUICallback('selectOutfit', function(data)
    ...
    TriggerEvent('ctn-clothing:client:loadOutfit', data)
end)
...
RegisterNetEvent('ctn-clothing:client:openMenu')
AddEventHandler('ctn-clothing:client:openMenu', function()
...
RegisterNUICallback('saveOutfit', function(data, cb)
    ...
    TriggerServerEvent('ctn-clothes:saveOutfit', data.outfitName, model, skinData)
end)

RegisterNetEvent('ctn-clothing:client:reloadOutfits')
AddEventHandler('ctn-clothing:client:reloadOutfits', function(myOutfits)
    SendNUIMessage({
...
RegisterNUICallback('removeOutfit', function(data, cb)
    TriggerServerEvent('ctn-clothing:server:removeOutfit', data.outfitName, data.outfitId)
...
function SaveSkin()
	...
	TriggerServerEvent("ctn-clothing:saveSkin", model, clothing)
end

RegisterNetEvent('ctn-clothes:client:CreateFirstCharacter')
AddEventHandler('ctn-clothes:client:CreateFirstCharacter', function()
...
RegisterNetEvent("ctn-clothes:loadSkin")
AddEventHandler("ctn-clothes:loadSkin", function(new, model, data)
    ...
    Citizen.CreateThread(function()
        ...
        TriggerEvent('ctn-clothing:client:loadPlayerClothings', data, GetPlayerPed(-1))
    end)
end)

RegisterNetEvent('ctn-clothing:client:loadPlayerClothings')
AddEventHandler('ctn-clothing:client:loadPlayerClothings', function(data, ped)
...
RegisterNetEvent('ctn-clothing:client:loadOutfit')
AddEventHandler('ctn-clothing:client:loadOutfit', function(oData)
    local ped = GetPlayerPed(-1)
...
RegisterNetEvent("ctn-clothing:client:adjustfacewear")
AddEventHandler("ctn-clothing:client:adjustfacewear",function(type)
...
--RegisterNetEvent('ctn-clothing:client:popo')
--AddEventHandler('ctn-clothing:client:popo', function()

--    local myData = QBCore.Functions.GetPlayerData()
--
 --   TriggerEvent("chatMessage",  'Your Crafting Points is '..myData.metadata.craftingrep..'')
--end)
