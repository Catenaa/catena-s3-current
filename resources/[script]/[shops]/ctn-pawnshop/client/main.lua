			...
			if GetDistanceBetweenCoords(pos.x, pos.y, pos.z, Config.PawnLocation.x, Config.PawnLocation.y, Config.PawnLocation.z, true) < 1.5 then
				...
				elseif sellItemsSet and sellPrice ~= 0 then
					...
					if IsControlJustReleased(0, Keys["E"]) then
						...
						QBCore.Functions.Progressbar("sell_pawn_items", "Selling ​​Items ..", math.random(10000, 20000), false, true, {}, {}, {}, {}, function() -- Done
							ClearPedTasks(GetPlayerPed(-1))
							TriggerServerEvent("ctn-pawnshop:server:sellPawnItems")
			...
			if GetDistanceBetweenCoords(pos.x, pos.y, pos.z, Config.PawnHardwareLocation.x, Config.PawnHardwareLocation.y, Config.PawnHardwareLocation.z, true) < 1.5 then
				...
				elseif sellHardwareItemsSet and sellHardwarePrice ~= 0 then
					...
					if IsControlJustReleased(0, Keys["E"]) then
						...
						QBCore.Functions.Progressbar("sell_pawn_items", "Selling ​​Items ..", math.random(10000, 20000), false, true, {}, {}, {}, {}, function() -- Done
							ClearPedTasks(GetPlayerPed(-1))
							TriggerServerEvent("ctn-pawnshop:server:sellHardwarePawnItems")
...
function GetSellingPrice()
	local price = 0
	QBCore.Functions.TriggerCallback('ctn-pawnshop:server:getSellPrice', function(result)
		price = result
	end)
	Citizen.Wait(500)
	return price
...
function GetSellingHardwarePrice()
	local price = 0
	QBCore.Functions.TriggerCallback('ctn-pawnshop:server:getSellHardwarePrice', function(result)
		price = result
	end)
	Citizen.Wait(500)
	return price
