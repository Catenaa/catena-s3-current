...
local bennyLocation = vector3(-199.08, -1324.238, 30.52)
local bennyPaletoLocation = vector3(109.89, 6627.07, 31.78)


local bennyHeading = 92.47
...
function AttemptPurchase(type, upgradeLevel)
    ...
    TriggerServerEvent("ctn-bennys:attemptPurchase", type, upgradeLevel)
...
Citizen.CreateThread(function()
    while true do 
        ...
        if IsPedInAnyVehicle(plyPed, false) then
            ...
            nearDefault = isNear(plyPos, bennyLocation, 5) 
...
Citizen.CreateThread(function()
    while true do 
        ...
        if IsPedInAnyVehicle(plyPed, false) then
            ...
            nearDefault = isNear(plyPos, bennyPaletoLocation, 5) 
...
--#[Event Handlers]#--
RegisterNetEvent("ctn-bennys:purchaseSuccessful")
AddEventHandler("ctn-bennys:purchaseSuccessful", function()
    isPurchaseSuccessful = true
    attemptingPurchase = false
    QBCore.Functions.Notify("Purchase Successful")
end)

RegisterNetEvent("ctn-bennys:purchaseFailed")
AddEventHandler("ctn-bennys:purchaseFailed", function()
